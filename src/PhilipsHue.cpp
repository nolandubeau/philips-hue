...
uint8_t PhilipsHue::begin(const char* hueBridgeIP, int hueBridgePort, const char* userId)
{	
...
const char* PhilipsHue::_lightStateEndpoint(uint8_t lightId)
{
	String endpoint = "/api/";
...
http_response_t PhilipsHue::lightOff(uint8_t lightId)
{
	// #ifdef DEBUG
	// 	Serial.println();Serial.print("Light ID: ");
